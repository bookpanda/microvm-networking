...
sudo cloud-hypervisor \
    ...
    --net mac=52:54:00:02:d9:01,vhost_user=true,socket=/tmp/vhost-user1,num_queues=8,vhost_mode=server,queue_size=1024
...
sudo cloud-hypervisor \
    ...
    --net mac=52:54:20:11:C5:02,vhost_user=true,socket=/tmp/vhost-user1,num_queues=8,vhost_mode=server,queue_size=1024
